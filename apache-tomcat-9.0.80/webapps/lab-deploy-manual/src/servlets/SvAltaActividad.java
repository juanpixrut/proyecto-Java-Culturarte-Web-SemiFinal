...
//! IMPORTANTE LEER
                ...
                uploadPath = RutaProyecto.getRuta() + "imagenes_actividad";   //getServletContext().getRealPath("") +"../.." +File.separator +"imagenes_perfil";
...
// En este punto, la imagen se ha guardado en la carpeta "uploads" en el servidor
            ...
            try {
                sys.AltaActividadTuristica(correoProv, nombre, descripcion, Integer.parseInt(duracion), Integer.parseInt(costo), depto, LocalDate.now(), ciudad, listCats, rutaimg);
            }catch(Exception e){}
