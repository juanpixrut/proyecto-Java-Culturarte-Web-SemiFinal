...
public class SvModificarUsuario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ISistema sys3 = new Fabrica().getSistema();
        ...
        if (usr3 != null) {
            try {
                ...
                //! IMPORTANTE LEER
                    ...
                    uploadPath = RutaProyecto.getRuta() + "imagenes_perfil/";   //getServletContext().getRealPath("") +"../.." +File.separator +"imagenes_perfil";
...
// Escribe el archivo en el directorio de carga
                ...
                if(nuevaFechaNacimiento.isEmpty()){
                    fechaNacimiento = LocalDate.parse(usr3.getFecNac());
                }
                //if(rutaimg==null){
                  //  rutaimg=usr3.getImagenP();
                //}
