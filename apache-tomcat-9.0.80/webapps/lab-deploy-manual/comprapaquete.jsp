...
<%@page import="logica.Inscripcion_paquete"%>
...
<body>
    ...
    %>
        ...
        <br>
        <h6>Costo del Paquete: <%=paquetes.getDescuento()%></h6>
        <br>
         ...
         <div class="form-group">
              <h6>Vencimiento:</h6>
                <input type="date" class="form-control form-control-user" id="Vencimiento" name="Vencimiento" placeholder="Vencimiento">
        </div>
