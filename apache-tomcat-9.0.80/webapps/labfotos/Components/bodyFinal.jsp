...
<%@page contentType="text/html" pageEncoding="UTF-8"%>
                                        ...
                                        <!-- Page level plugins -->
                                        <script src="ComponentsBoostrap/vendor/chart.js/Chart.min.js"></script>

                                        <!-- Page level custom scripts -->
                                        <script src="ComponentsBoostrap/js/demo/chart-area-demo.js"></script>
                                        <script src="ComponentsBoostrap/js/demo/chart-pie-demo.js"></script>
