                     ...
                     window.location.href = "SvAltaSalidaTuristica?nombreDep=" + selectedValue;
                                ...
                                <form action="SvAltaSalidaTuristica" id="altaSalidaForm" class="user" method="POST" enctype="multipart/form-data">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="lugar" name="lugar" placeholder="Lugar">
                                        </div>
                                        <div class="form-group">
                                            <input type="number" class="form-control form-control-user" id="cantidad" name="cantidad" placeholder="Cantidad">
                                        </div>
                                        <div class="form-group">
                                            <input type="date" class="form-control form-control-user" id="fechaSalida" name="fechaSalida" placeholder="Fecha de Salida">
                                        </div>
