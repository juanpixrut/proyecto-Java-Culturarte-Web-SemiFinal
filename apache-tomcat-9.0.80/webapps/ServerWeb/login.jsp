...
<html lang="en">
    ...
    <%
        String alertar = request.getParameter("msg");
        String mensaje = "";
        if (alertar != null) {
            if (alertar.equals("reintentar")) {
                mensaje = "Error, intente de nuevo";
            } else if (alertar.equals("usrcreado")) {
                mensaje = "Usuario creado con exito, inicie sesion";
            }
        }
    %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <div class="text-center">
                                            <a class="small" href="registrarse">Create an Account!</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
